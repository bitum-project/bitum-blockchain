...
Usage:
  ...
  bin/" . BlockchainConfig::NAME . "-wallet --wallet-file=bitum-wallet --wallet-password=veryStrongPassword --node-address=127.0.0.1:8087 --node-protocol=http --data-folder=./ --prefix=" . BlockchainConfig::NAME . "
Options:
  --help                                 Show help console
